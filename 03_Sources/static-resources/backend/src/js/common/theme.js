/*
 * ! AdminLTE app.js ================ Main JS application file for AdminLTE v2.
 * This file should be included in all pages. It controls some layout options
 * and implements exclusive AdminLTE plugins.
 * 
 * @Author Almsaeed Studio @Support <http://www.almsaeedstudio.com> @Email
 * <abdullah@almsaeedstudio.com>
 * 
 * @version 2.3.8 @license MIT <http://opensource.org/licenses/MIT>
 */
...
function _init() {
  ...
  $.AdminLTE.pushMenu = {
    activate: function(toggleBtn) {
      ...
      $(document).on('click', toggleBtn, function(e) {
        ...
        $(".fixedColumnsTable").css("left", "");
        $(".fixedColumnsTable").css("right", 0);
      });
   ...
   * 
   * @type Object @usage $.AdminLTE.boxWidget.activate() Set all your options in
   * the main $.AdminLTE.options object
   */
  $.AdminLTE.boxWidget = {
